                        ...
                        <div class="col-lg-6">
                            <form role="form" method="post" action="<?php echo U('Admin/Cate/insert');?>" >
                                <div class="form-group">
                                    ...
                                    <?php if(is_array($cates)): foreach($cates as $key=>$vo): ?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); echo ($vo["id"]); ?></option><?php endforeach; endif; ?>
                                    </select>
                                </div>

                                <div class="form-group">
                                    <label>分类名</label>
                                    <input name="name" placeholder="请输入分类名" class="form-control">
                                </div>
